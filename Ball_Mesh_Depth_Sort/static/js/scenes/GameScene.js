...
export default class GameScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.text('bevelledcube', 'data/bevelledcube.obj');
        this.load.text('geosphere', 'data/geosphere.obj');
        this.load.text('implodedcube', 'data/implodedcube.obj');
        this.load.text('spike', 'data/spike.obj');
        this.load.text('torus', 'data/torus.obj');
    }
