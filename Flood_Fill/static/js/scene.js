...
const Flood = new Phaser.Class({
    ...
    preload: function () {
        ...
        this.load.bitmapFont('atari', 'fonts/atari_smooth.png', 'fonts/atari_smooth.xml');
        this.load.atlas('flood', 'images/monsters.png', 'data/monsters.json');
    },
    ...
    create: function () {
        ...
        this.text1 = this.add.bitmapText(684, 30, 'atari', 'Moves', 18).setAlpha(0);
        this.text2 = this.add.bitmapText(694, 60, 'atari', '00', 24).setAlpha(0);
        this.text3 = this.add.bitmapText(this.cameras.main.width / 2, this.cameras.main.height / 2, 'atari', 'So close!\n\nClick to\ntry again', 36).setAlpha(0).setOrigin(0.5, 0.5);
