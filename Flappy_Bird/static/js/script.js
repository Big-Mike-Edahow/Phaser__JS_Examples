...
function preload() {
    ...
    this.load.image('bird_1', 'images/redbird-downflap.png');
    this.load.image('bird_2', 'images/redbird-midflap.png');
    this.load.image('bird_3', 'images/redbird-upflap.png');
    this.load.image('base', 'images/base.png');
    this.load.image('piller', 'images/pipe-red.png');
    this.load.image('startGame', 'images/start_game.png');
    this.load.image('gameOver', 'images/label_game_over.png');
    this.load.image('resumeButton', 'images/button_resume.png');
    this.load.audio('score', 'sounds/point.wav');
